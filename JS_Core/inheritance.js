// 📦 Example: Product & DiscountedProduct (Real-World Inheritance)

// Definition:
// Inheritance in JavaScript allows a class (child) to acquire properties and methods
// from another class (parent). This promotes reusability and avoids code duplication.
...
class Product {
  ...
  /*
  Theory:
  1. Product is the base (parent) class → common properties and methods for all products.
  2. DiscountedProduct extends Product → inherits all Product properties/methods.
